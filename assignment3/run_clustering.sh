...
python run_experiment.py --ica --dataset1 --dim 40 --skiprerun --verbose --threads -1 > ica-dataset1-clustering.log 2>&1
python run_experiment.py --ica --dataset2 --dim 6 --skiprerun --verbose --threads -1 > ica-dataset2-clustering.log 2>&1
...
python run_experiment.py --rf  --dataset1 --dim 15 --skiprerun --verbose --threads -1 > rf-dataset1-clustering.log  2>&1
